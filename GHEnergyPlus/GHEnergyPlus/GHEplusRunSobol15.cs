...
{
    public class GHEplusRunSobol15 : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GHEplusRunSobol15 class.
        /// </summary>
        public GHEplusRunSobol15()
            : base("Sobol15Waibel", "Sobol15",
                "Sobol 15 Waibel et al 2016, four office volumes",
            ...
            if (runit == true)
            {
                ...
                for (int j = 0; j < sobparameterset.Count; j++)
                {
                    ...
                    for (int BLD = 0; BLD < 4; BLD++)
                    {
                        ...
                        fileStream = new FileStream(path_in + idffile + "_L" + levels.ToString() + ".idf", FileMode.Open, FileAccess.Read);
                        using (var streamReader = new StreamReader(fileStream))
                        {
                            string line;
                            while ((line = streamReader.ReadLine()) != null)
                    ...
                    sobResultsStr[j] = totCost.ToString();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return GHEnergyPlus.Properties.Resources.sobol_15;
            }
        }
        ...
        {
            get { return new Guid("{04e5088e-c64b-449b-8d8d-b42ba8b1b3ff}"); }
        }
    }
}