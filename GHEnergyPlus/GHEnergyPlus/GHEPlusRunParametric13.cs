...
namespace GHEnergyPlus
{
  public class GHEPlusRunParametric13 : GH_Component
  {
    ...
    public GHEPlusRunParametric13(): base("Prob13Djuric", "Prob13Djuric", "Problem 13 Djuric (now Nord) 2007, school building.", "EnergyHubs", "BuildingSimulation")
    {
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      Misc.RunEplus(path_out, command, directory1);
